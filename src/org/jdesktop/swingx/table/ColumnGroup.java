...
public class ColumnGroup implements Comparable<ColumnGroup> {
    ...
    public ColumnGroup(TableCellRenderer renderer, Object headerValue) {
...
//            setHeaderRenderer(new DefaultTableCellRenderer());
     ...
     */
    public void getGroupsForColumn(TableColumn column, List<ColumnGroup> groupList) {
        if (columns != null) {
...
//                }
    ...
    public Dimension getSize(JTable table) {
        ...
        Dimension size = new Dimension(0, 40);//comp.getPreferredSize().height);
...
// Set the margin for nested groups    
    ...
    public int compareTo(ColumnGroup o) {
        String hv = (String) this.headerValue;
        String ohv = (String) o.headerValue;
        return hv.compareTo(ohv);
    }
}