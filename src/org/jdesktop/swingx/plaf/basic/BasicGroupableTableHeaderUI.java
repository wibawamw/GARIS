/*
 * $Id: BasicGroupableTableHeaderUI.java 884 2006-09-28 07:30:31Z evickroy $
 *
 ...
 * @author erik
 */
public class BasicGroupableTableHeaderUI extends GroupableTableHeaderUI {
...
// Only if there are columns
        if (columnModel != null) {
            ...
            for (int columnIndex = 0; columnIndex < columnModel.getColumnCount(); columnIndex++) {
                ...
                List<ColumnGroup> groupList = ((JXGroupableTableHeader) header).getGroupsForColumn(column);
...
// Calculate the collective height for this column
            int height = component.getPreferredSize().height;//component.getPreferredSize().height;
...
//                        }
                        List<ColumnGroup> draggedGroupList = ((JXGroupableTableHeader) header).getGroupsForColumn(draggedColumn);
                        List<ColumnGroup> evalGroupList = ((JXGroupableTableHeader) header).getGroupsForColumn(evalColumn);
