 ...
 */
public class MotekarViewerPanel extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    public MotekarViewerPanel(String fileName, boolean isXML) throws JRException {
        this(fileName, isXML, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(InputStream is, boolean isXML) throws JRException {
        this(is, isXML, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(JasperPrint jrPrint) {
        this(jrPrint, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(String fileName, boolean isXML, Locale locale) throws JRException {
        this(fileName, isXML, locale, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(InputStream is, boolean isXML, Locale locale) throws JRException {
        this(is, isXML, locale, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(JasperPrint jrPrint, Locale locale) {
        this(jrPrint, locale, null);
    }

    /** Creates new form JRViewer */
    public MotekarViewerPanel(String fileName, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException {
    ...
    /** Creates new form JRViewer */
    public MotekarViewerPanel(InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException {
        initResources(locale, resBundle);
    ...
    /** Creates new form JRViewer */
    public MotekarViewerPanel(JasperPrint jrPrint, Locale locale, ResourceBundle resBundle) {
        initResources(locale, resBundle);
                ...
                new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            MotekarViewerPanel.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                            JasperPrintManager.printReport(jasperPrint, true);
                        } catch (Exception ex) {
                            if (log.isErrorEnabled()) {
                                log.error("Print error.", ex);
                            }
                            JOptionPane.showMessageDialog(MotekarViewerPanel.this, getBundleString("error.printing"));
                        } finally {
                            MotekarViewerPanel.this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    ...
    protected void paintPage(Graphics2D grx) {
        ...
        try {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    JOptionPane.showMessageDialog(MotekarViewerPanel.this, getBundleString("error.displaying"));
                }
            });
        }
    ...
    class PageRenderer extends JLabel {
        ...
        MotekarViewerPanel viewer = null;

        public PageRenderer(MotekarViewerPanel viewer) {
            this.viewer = viewer;
        }
