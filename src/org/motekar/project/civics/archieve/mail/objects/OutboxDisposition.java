...
public class OutboxDisposition {
    ...
    public int hashCode() {
        ...
        hash = 41 * hash + (this.receipient != null ? this.receipient.hashCode() : 0);
        hash = 41 * hash + (this.receipientAddress != null ? this.receipientAddress.hashCode() : 0);
        hash = 41 * hash + (this.receiveDate != null ? this.receiveDate.hashCode() : 0);
        hash = 41 * hash + (this.status != null ? this.status.hashCode() : 0);
        hash = 41 * hash + (this.outboxIndex != null ? this.outboxIndex.hashCode() : 0);
        return hash;
    }
