...
public class InboxDisposition {
    ...
    public int hashCode() {
        ...
        hash = 23 * hash + (this.division != null ? this.division.hashCode() : 0);
        hash = 23 * hash + (this.receiveDate != null ? this.receiveDate.hashCode() : 0);
        hash = 23 * hash + (this.status != null ? this.status.hashCode() : 0);
        hash = 23 * hash + (this.inboxIndex != null ? this.inboxIndex.hashCode() : 0);
        return hash;
    }
