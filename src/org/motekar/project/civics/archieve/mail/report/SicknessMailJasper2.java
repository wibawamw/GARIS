...
public class SicknessMailJasper2 extends AbstractJasper {
    ...
    public SicknessMailJasper2(SicknessMail sicknessMail, ProfileAccount profileAccount,Unit unit) {
        ...
        try {
            SwingWorker<JasperReport, Void> worker = new SwingWorker<JasperReport, Void>() {
                ...
                protected JasperReport doInBackground() throws Exception {
                    try {
                        String filename = System.getProperty("user.dir") + File.separator + File.separator + "printing" + File.separator + "SicknessMail2.jrxml";
                ...
                protected Map doInBackground() throws Exception {
                    ...
                    if (sicknessMail != null) {
                        ...
                        if (unit != null) {
                            ...
                            unitName = unitName.replaceAll("UPT.", "");
                            unitName = unitName.replaceAll("UPT", "");
