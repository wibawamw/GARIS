 ...
 */
public class DoctorMailJasper extends AbstractJasper {
    ...
    public DoctorMailJasper(DoctorMail doctorMail, ProfileAccount profileAccount,Unit unit) {
        ...
        try {
            SwingWorker<JasperReport, Void> worker = new SwingWorker<JasperReport, Void>() {
                ...
                protected JasperReport doInBackground() throws Exception {
                    try {
                        String filename = System.getProperty("user.dir") + File.separator + File.separator + "printing" + File.separator + "DoctorMail.jrxml";
