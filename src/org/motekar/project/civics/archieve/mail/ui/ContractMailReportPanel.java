...
public class ContractMailReportPanel extends JXPanel implements ActionListener {
    ...
    public ContractMailReportPanel(ArchieveMainframe mainframe) {
    ...
    private JXPanel createRightComponent() {
        ...
        String text = "Penjelasan Singkat\n"
                + "Daftar Surat Keluar Kontrak merupakan daftar semua surat yang dikeluarkan dinas beserta statusnya "
                + "pada dinas tertentu\n"
                + "Untuk melihat data Surat Keluar Kontrak pilih periode berdasarkan tanggal, berdasarkan bulan,"
                ...
                + "Untuk melakukan cetak daftar Surat Keluar Kontrak, dari data yang telah difilter sebelumnya (panel dibawah) "
        ...
        task.setTitle("Cetak Daftar Surat Keluar Kontrak");
    ...
    private class LoadPrintPanel extends SwingWorker<JasperPrint, Void> {
        ...
        private DefaultTableModel constructModel(ArrayList<ContractMail> data) throws InterruptedException, SQLException {
        ...
        protected JasperPrint doInBackground() throws Exception {
            try {
                ...
                ArrayList<ContractMail> mail = new ArrayList<ContractMail>();

                if (startDate != null && endDate != null) {
                    mail = logic.getContractMail(mainframe.getSession(), startDate, endDate);
                } else if (month != 0 || year != 0) {
                    mail = logic.getContractMail(mainframe.getSession(), month, year);
                }
        ...
        protected void done() {
            try {
                ...
                JXErrorPane.showDialog(ContractMailReportPanel.this, info);
            }
            setProgress(100);
