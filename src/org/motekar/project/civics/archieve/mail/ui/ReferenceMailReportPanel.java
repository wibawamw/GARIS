 ...
 */
public class ReferenceMailReportPanel extends JXPanel implements ActionListener {
    ...
    public ReferenceMailReportPanel(ArchieveMainframe mainframe) {
    ...
    private JXPanel createRightComponent() {
        ...
        String text = "Penjelasan Singkat\n"
                + "Daftar Surat Keluar Rujukan merupakan daftar semua surat yang dikeluarkan dinas beserta statusnya "
                + "pada dinas tertentu\n"
                + "Untuk melihat data Surat Keluar Rujukan pilih periode berdasarkan tanggal, berdasarkan bulan,"
                ...
                + "Untuk melakukan cetak daftar Surat Keluar Rujukan, dari data yang telah difilter sebelumnya (panel dibawah) "
        ...
        task.setTitle("Cetak Daftar Surat Keluar Rujukan");
    ...
    private class LoadPrintPanel extends SwingWorker<JasperPrint, Void> {
        ...
        private DefaultTableModel constructModel(ArrayList<ReferenceMail> data) throws InterruptedException, SQLException {
        ...
        protected JasperPrint doInBackground() throws Exception {
            try {
                ...
                ArrayList<ReferenceMail> mail = new ArrayList<ReferenceMail>();

                if (startDate != null && endDate != null) {
                    mail = logic.getReferenceMail(mainframe.getSession(), startDate, endDate);
                } else if (month != 0 || year != 0) {
                    mail = logic.getReferenceMail(mainframe.getSession(), month, year);
                }
        ...
        protected void done() {
            try {
                ...
                JXErrorPane.showDialog(ReferenceMailReportPanel.this, info);
            }
            setProgress(100);
