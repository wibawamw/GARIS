...
public class ExpeditionBusinessLogic {
    ...
    public String generatedExpeditionCode(Long session, Integer year) throws SQLException {
        try {
            if (!auth.isSessionExpired(session)) {
                throw new MotekarException("Session anda telah berakhir silahkan login kembali");
            }

            String maxCode = sql.getMaxCode(conn, "expedition", "docnumber", year.toString());


            ArrayList<String> al = new ArrayList<String>();

            StringTokenizer token = new StringTokenizer(maxCode, "/");
            ...
            if (maxCode.equals("")) {
                generatedCode.append("090/001/SPPD/").append(year);
            } else {
                if (al.isEmpty()) {
                    generatedCode.append("090/001/SPPD/").append(year);
                } else {
                    Integer num = Integer.valueOf(al.get(1));
                    num++;
                    ...
                    switch (nextCode.length()) {
                        case 1:
                            generatedCode.append("090/").append("00").append(nextCode).append("/SPPD/").append(year);
                            break;
                        case 2:
                            generatedCode.append("090/").append("0").append(nextCode).append("/SPPD/").append(year);
                            break;
                        case 3:
                            generatedCode.append("090/").append(nextCode).append("/SPPD/").append(year);
                            break;
                    }
                }
    ...
    public String generatedAssignmentLetterCode(Long session, Integer year) throws SQLException {
        try {
            if (!auth.isSessionExpired(session)) {
                throw new MotekarException("Session anda telah berakhir silahkan login kembali");
            }

            String maxCode = sql.getMaxCode(conn, "assignmentletter", "docnumber", year.toString());
            ...
            if (maxCode.equals("")) {
                generatedCode.append("090/001/ST/").append(year);
            } else {
                if (al.isEmpty()) {
                    generatedCode.append("090/001/ST/").append(year);
                } else {
                    ...
                    switch (nextCode.length()) {
                        case 1:
                            generatedCode.append("090/").append("00").append(nextCode).append("/ST/").append(year);
                            break;
                        case 2:
                            generatedCode.append("090/").append("0").append(nextCode).append("/ST/").append(year);
                            break;
                        case 3:
                            generatedCode.append("090/").append(nextCode).append("/SPPD/").append(year);
                            break;
