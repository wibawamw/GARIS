...
public class ArchieveTableCreatorSQL {
    ...
    public void installRegulationTable(Statement stm) throws SQLException {
        StringBuilder query = new StringBuilder();
        query.append("CREATE TABLE regulation").
                append("(").
                append("autoindex bigserial NOT NULL,").
                append("regulationnumber text,").
                append("regulationdate date,").
                append("description text,").
                append("CONSTRAINT regulation_pkey PRIMARY KEY (autoindex)").

                append(")");

        stm.executeUpdate(query.toString());
        System.out.println("Regulation Table Installed");
    }

    public void uninstallRegulationTable(Statement stm) throws SQLException {
        StringBuilder query = new StringBuilder();
        query.append("DROP TABLE regulation CASCADE");

        stm.executeUpdate(query.toString());
        System.out.println("Regulation Table Uninstalled");
    }

    public void installDecreeTable(Statement stm) throws SQLException {
        StringBuilder query = new StringBuilder();
        query.append("CREATE TABLE decree").
                append("(").
                append("autoindex bigserial NOT NULL,").
                append("decreenumber text,").
                append("decreedate date,").
                append("description text,").
                append("CONSTRAINT decree_pkey PRIMARY KEY (autoindex)").

                append(")");

        stm.executeUpdate(query.toString());
        System.out.println("Decree Table Installed");
    }

    public void uninstallDecreeTable(Statement stm) throws SQLException {
        StringBuilder query = new StringBuilder();
        query.append("DROP TABLE decree CASCADE");

        stm.executeUpdate(query.toString());
        System.out.println("Decree Table Uninstalled");
    }
