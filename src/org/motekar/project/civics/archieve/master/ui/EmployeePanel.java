...
public class EmployeePanel extends JXPanel implements ActionListener, ListSelectionListener {
    ...
    protected Component createMainPanel() {
        ...
        builder.addLabel("DPR ?", cc.xy(1, 1));
    ...
    private Employee getEmployee() throws MotekarException {
        ...
        String positionNotes = fieldPosNotes.getText();
        ...
        if (!isGorvernor) {
            ...
            if (positionNotes.equals("")) {
                errorString.append("<br>- Keterangan Jabatan</br>");
            }
        }
        ...
        employee.setPositionNotes(positionNotes);
