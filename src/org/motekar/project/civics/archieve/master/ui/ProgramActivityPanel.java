...
public class ProgramActivityPanel extends JXPanel implements ActionListener {
    ...
    private JXPanel createRightComponent() {
        ...
        String text = "Penjelasan Singkat\n"
                + "Fasilitas Program / Kegiatan untuk pengisian data-data Program / Kegiatan yang ada di suatu dinas\n\n"
                ...
                + "kemudian akan muncul peringatan untuk menghapus Program / Kegiatan "
    ...
    private void onEdit() {
        ...
        statusLabel.setText("Ubah Program / Kegiatan");
        defineCustomFocusTraversalPolicy();
    }
