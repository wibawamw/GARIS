...
import org.motekar.project.civics.archieve.mail.ui.RegulationRibbonBand;
...
public class ArchieveMainframe extends JRibbonFrame implements ActionListener {
    ...
    private void configureRibbon() {
        ...
        RegulationRibbonBand rBandRegulation = new RegulationRibbonBand(this, "SK & Perda", null);
        ...
        RibbonTask task1 = new RibbonTask("Master Data & Surat", nav1, rBandMasterData,
                mail.getMailInboxRibbon(), mail.getMailOutboxRibbon(), rBandRegulation, rBandExpedition);

        RibbonTask task2 = new RibbonTask("Laporan-Laporan", nav2, report.getDataMasterRibbon(), report.getMailReportRibbon(),
                report.getRegulationReport(), report.getExpeditionReport());
